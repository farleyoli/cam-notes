...
\]
The scale factors $h_u$, $h_v$, $h_w$ relate changes in the coordinates to physical distances along each orthogonal direction.
...
We illustrate the third approach for the curl. Recall that
\[
...
\]
The other components follow by cyclic permutation. The divergence formula can be derived similarly using the integral definition.
